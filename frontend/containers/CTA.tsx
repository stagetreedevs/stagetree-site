  ...
  return (
    <section className='w-full py-40 relative'>
      <div className='maxContainer paddingContainer flexBetween flex-col lg:flex-row gap-16'>
        <h2 className='bold-24 mb-6 text-center lg:text-start lg:bold-44'><span className='text-green-100'>Transformando</span> sua experiência com produtos digitais</h2>
