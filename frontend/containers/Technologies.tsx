...
const Technologies = () => {
    ...
    return (
        <section className='w-full py-40'>
            <div className='maxContainer paddingContainer flexBetween'>
                <div>
                    <h2 className='bold-24 mb-4 text-center lg:text-start lg:bold-44'>
                        <span className='text-green-100'>Tecnologias</span> que usamos
                    </h2>
                    <p>{hoveredDescription || 'São apenas ferramentas que usamos para criar experiências incríveis e valiosas.'}</p>
                </div>
                <TechnologieCard
